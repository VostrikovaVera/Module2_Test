...
namespace Module2_Test.Models.Entities.HealthBeauty.HairDryer
{
    ...
    {
        public HairDryer(DateTime dateOfManufacture, Countries countryProducer, Producers producerName, string modelName, double width, double height, double length, int wattage, int numberOfSpeed)
