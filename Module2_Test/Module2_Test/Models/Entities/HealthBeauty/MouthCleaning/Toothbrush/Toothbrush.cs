...
namespace Module2_Test.Models.Entities.HealthBeauty.MouthCleaning.Toothbrush
{
    ...
    {
        public Toothbrush(DateTime dateOfManufacture, Countries countryProducer, Producers producerName, string modelName, double width, double height, double length, int wattage, CleaningTechnologyTypes cleaningTechnologyType)
