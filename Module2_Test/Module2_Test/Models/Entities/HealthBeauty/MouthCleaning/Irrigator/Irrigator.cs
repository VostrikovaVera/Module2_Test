...
namespace Module2_Test.Models.Entities.HealthBeauty.MouthCleaning.Irrigator
{
    ...
    {
        public Irrigator(DateTime dateOfManufacture, Countries countryProducer, Producers producerName, string modelName, double width, double height, double length, int wattage, CleaningTechnologyTypes cleaningTechnologyType, double liquidContaiberVolume, double liquidContainerVolume)
